...
describe Book do
  ...
  describe "capitalize?" do
    it "retorna false em alguns casos" do
      @book.capitalize?("an").should == false
      @book.capitalize?("the").should == false
      @book.capitalize?("for").should == false
      @book.capitalize?("man").should == true
      @book.capitalize?("a").should == false
      @book.capitalize?("apple").should == true
      @book.capitalize?("inferno").should == true
    end
  end
end
